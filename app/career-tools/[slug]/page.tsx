  ...
  const renderFormFields = () => {
    ...
    if (s.includes("cover-letter")) {
      return (
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                onChange={(e) =>
                  handleInputChange("writing_tone", e.target.value)
                }
                className="w-full h-[40px] rounded-full border border-[#E8E8E8] bg-white px-3 text-[14px]"
              >
                {[
                  "Professional",
                  "Friendly",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <Label>Relevant Experience (Max 200 chars)</Label>
              <Textarea
            ...
            <div className="space-y-1.5">
              <Label>Job Description (Optional, Max 200 chars)</Label>
              <Textarea
    ...
    if (s.includes("email")) {
      return (
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <select
                ...
                onChange={(e) =>
                  handleInputChange("email_type", e.target.value)
                }
                className="w-full h-[40px] rounded-full border border-[#E8E8E8] bg-white px-3 text-[14px]"
              >
                {emailTypes.map((t) => (
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                onChange={(e) =>
                  handleInputChange("email_tone", e.target.value)
                }
                className="w-full h-[40px] rounded-full border border-[#E8E8E8] bg-white px-3 text-[14px]"
              >
                {emailTones.map((t) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleInputChange("recipient_role", e.target.value)
                }
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            <Label>Context Details (Max 200 chars)</Label>
            <Textarea
    ...
    if (s.includes("resume-optimizer")) {
      return (
        <>
          <div className="space-y-1.5">
            <Label>Your Current Resume (Paste Content)</Label>
            <Textarea
              value={formData.current_resume || ""}
              onChange={(e) =>
                handleInputChange("current_resume", e.target.value)
              }
              rows={6}
            />
          </div>
      ...
      return (
        <>
          ...
          <div className="space-y-1.5">
            <Label>Key Skills</Label>
            <Input
              placeholder="React, Node, Leadership"
              value={formData.key_skills || ""}
              onChange={(e) => handleInputChange("key_skills", e.target.value)}
            />
          </div>
        ...
        <>
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full h-[40px] rounded-full border border-[#E8E8E8] bg-white px-3"
            >
              {[
                "Educational",
                "Story-telling",
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full h-[40px] rounded-full border border-[#E8E8E8] bg-white px-3"
            >
              {["Professional", "Casual", "Bold", "Humorous"].map((t) => (
                <option key={t} value={t}>
                  {t}
                </option>
              ))}
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              onChange={(e) =>
                handleInputChange("additional_context", e.target.value)
              }
              rows={3}
            />
          </div>
      ...
      return (
        <>
          ...
          <div className="space-y-1.5">
            ...
            <Input
              placeholder="e.g. Fintech Recruiters"
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full h-[40px] rounded-full border border-[#E8E8E8] bg-white px-3"
            >
              {["Confident", "Professional", "Approachable", "Creative"].map(
                (t) => (
                  <option key={t} value={t}>
                    {t}
                  </option>
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              onChange={(e) =>
                handleInputChange("experience_background", e.target.value)
              }
              rows={3}
            />
          </div>
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              onChange={(e) =>
                handleInputChange("key_achievements", e.target.value)
              }
              rows={3}
            />
          </div>
    ...
    if (s.includes("explore-careers") || s.includes("salary-analyzer")) {
      return (
        <>
          <div className="space-y-1.5">
            <Label>
              {s.includes("explore") ? "Career Job Title" : "Job Title"}
            </Label>
            <Input
              value={formData.career_job_title || formData.job_title || ""}
              onChange={(e) =>
                handleInputChange(
                  s.includes("explore") ? "career_job_title" : "job_title",
                  e.target.value,
                )
              }
            />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleInputChange("target_monthly_income", e.target.value)
                }
              />
            </div>
            <div className="space-y-1.5">
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full h-[40px] rounded-full border border-[#E8E8E8] bg-white px-3"
              >
                {["15 seconds", "30 seconds", "60 seconds"].map((t) => (
                  <option key={t} value={t}>
                    {t}
                  </option>
                ))}
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange("key_strengths_skills", e.target.value)
              }
            />
          </div>
          <div className="space-y-1.5">
            <Label>Unique Achievements</Label>
            <Textarea
      ...
      return (
        <>
          ...
          <div className="space-y-1.5">
            ...
            <Input
              placeholder="e.g. Reliable Fintech Expert"
              value={formData.desired_brand_perception || ""}
              onChange={(e) =>
                handleInputChange("desired_brand_perception", e.target.value)
              }
            />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-4 flex justify-center">
              <Button
                ...
                className="gap-2 px-10 h-14 bg-[#322FEB] hover:bg-[#322FEB]/90 rounded-full shadow-[0px_8px_16px_0px_#322FEB4D] transition-all active:scale-95 text-[16px]"
              >
                ...
                {generateMutation.isPending
                  ? "Generating Content..."
                  : `Generate ${tool?.name || "Content"} (${tool?.generate_token_cost || 0} tokens)`}
              </Button>
            </div>
          </form>
        </ToolFormWrapper>
