        ...
        <div className="space-y-6">
          <div className="space-y-4">
            ...
            <div
              ...
              onClick={() =>
                document.getElementById("profile_pdf_input")?.click()
              }
            >
              <input
                ...
                className="hidden"
                onChange={(e) =>
                  handleInputChange("profile_pdf", e.target.files?.[0])
                }
                accept=".pdf"
              />
              <CloudUploadIcon />
              <p className="text-[#161A21] text-[15px] mori-semibold mt-4">
                {formData.profile_pdf
                  ? formData.profile_pdf.name
              ...
              <Button
                variant="outline"
                type="button"
                className="mt-6 rounded-[20px] px-8 border-[#E8E8E8] text-[#161A21] h-11"
              >
                Browse File
              </Button>
            </div>
          ...
          <div className="space-y-5">
            <div className="space-y-2 text-left">
              <Label
                htmlFor="full_name"
                className="text-[#161A21] text-[14px] mori-semibold"
              >
                Full Name
              </Label>
              <Input
                ...
                className="h-12 rounded-full border-[#E8E8E8] focus:border-[#322FEB] transition-all"
              />
            </div>
            <div className="space-y-2 text-left">
              <Label
