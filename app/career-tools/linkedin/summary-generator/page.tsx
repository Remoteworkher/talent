      ...
      renderFields={(formData, handleInputChange) => (
        <div className="space-y-6">
          <div className="space-y-2 text-left">
            <Label className="text-[14px] mori-semibold text-[#161A21]">
              Current Role
            </Label>
            <Input
              ...
              className="h-12 rounded-full border-[#E8E8E8] focus:border-[#322FEB] focus:ring-1 focus:ring-[#322FEB] transition-all"
            />
          </div>
          ...
          <div className="space-y-2 text-left">
            ...
            <div className="relative">
              <select
                ...
                className="w-full h-12 rounded-full border border-[#E8E8E8] bg-white px-4 text-[14px] outline-none appearance-none bg-[url('/chevron-down.svg')] bg-[length:16px] bg-[right_16px_center] bg-no-repeat focus:border-[#322FEB] focus:ring-1 focus:ring-[#322FEB] transition-all text-[#6A6D71]"
              >
          ...
          <div className="space-y-2 text-left">
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-3 right-3 flex items-center gap-1.5 text-[12px] text-[#95969A]">
                ...
                >
                  <path
                    d="M16.5 3.5L20.5 7.5L7.5 20.5H3.5V16.5L16.5 3.5Z"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
